...
@Service
public class GetValuesFromUrlRecoveryData extends GetValuesFromUrlModel{
    ...
    public GetValuesFromUrlRecoveryData(RestTemplateUrlReader restTemplateUrlReader) {
